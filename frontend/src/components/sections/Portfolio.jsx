...
const projects = [
  { title: 'NexaCommerce', cat: 'E-commerce', desc: 'Full-stack e-commerce platform with AI-powered recommendations.', tags: ['React', 'Node.js', 'MongoDB'], color: '#00d4ff' },
  { title: 'VaultDash', cat: 'Dashboard', desc: 'Real-time analytics dashboard for fintech startup.', tags: ['Vue.js', 'D3.js', 'Express'], color: '#9d4edd' },
  { title: 'StudioPro', cat: 'Portfolio', desc: 'Award-winning portfolio for creative director in NYC.', tags: ['Next.js', 'GSAP', 'Tailwind'], color: '#ff006e' },
  { title: 'FutureBrand', cat: 'Branding', desc: 'Complete brand identity for a Web3 startup ecosystem.', tags: ['Figma', 'Illustrator', 'Motion'], color: '#00fff5' },
  { title: 'MedConnect', cat: 'Web App', desc: 'Healthcare patient management web application.', tags: ['React', 'TypeScript', 'AWS'], color: '#00d4ff' },
  { title: 'LuxeStore', cat: 'E-commerce', desc: 'Luxury fashion e-commerce with virtual try-on.', tags: ['Next.js', 'Stripe', 'Prisma'], color: '#9d4edd' },
]
          ...
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="font-body text-xs text-slate-400 mb-4 leading-relaxed">{p.desc}</p>
